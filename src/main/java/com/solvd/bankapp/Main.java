...
import com.solvd.bankapp.services.implMyBanatis.CustomerSerivce;
import com.solvd.bankapp.services.mysql.*;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import com.solvd.bankapp.services.implMySQl.CheckingService;
...
//        checkingService.writeToDb(new CheckingAccount( 777, 555555555, Date.valueOf("1991-03-12")));
...
//        Employee employee2 = new Employee(100, "Art", "Krylov",
//                "SDET",listAddress , new Payroll(1, PayType.FULL_TIME, 100000, 0), Date.valueOf("1991-01-01"));
//
//        //serializing employee
//        employeeJsonService.serialize(employee2);

        // mybatis vs mysql
        ICheckingService checkingService1 = new CheckingService();
        ICustomerService customerService = new CustomerSerivce();
        LOGGER.info(customerService.readFromDb(100000001));
